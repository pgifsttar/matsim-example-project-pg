...
import org.graalvm.compiler.hotspot.nodes.aot.PluginFactory_InitializeKlassStubCall;
...
public class RunMatsim{
	...
	public static void main(String[] args) {
		...
		//List<Id<Link>> linkToChangeCapacity = new ArrayList<>();
		//for (Id<l>)

		//for (Id<Link> linkId : linkToChangeCapacity) {
		...
		//Person person2 = populationFactory.createPerson(Id.createPersonId("Pascal"));
...
//		System.out.println("Population size =" + scenario.getPopulation().getPersons().size());
		...
		//--
		//for (Id<Link> 1) {
		//	scenario.getNetwork().removeLink(1);
		//}
